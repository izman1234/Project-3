...
//CHANGE BY RYO
//4/6/2020 Fixed a bug where the program crashes when it tries to compare to Pokemon objects
bool operator==(const Pokemon& poke1, const Pokemon& poke2)
{
	if (poke1.pokemonName == poke2.pokemonName && poke1.ivATK == poke2.ivATK && poke1.ivDEF == poke2.ivDEF && poke1.ivSTA == poke2.ivSTA && poke1.lvl == poke2.lvl)
		return true;
	else
		return false;
}
