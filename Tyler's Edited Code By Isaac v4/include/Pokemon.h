...
//- All CPM values cannot be used - works with tyler code - Am
#ifndef POKEMON_H
#define POKEMON_H
...
//comments checked and added by Ashley M
class Pokemon
{
public:
	//Default constructor
	...
	//Calculate damage multiplier for charge moves and fast moves
    ...
    //ADDED BY SKYYSHA/
    //Adds health to the Pokemon HP.
    int useHealthMove(int addh);
